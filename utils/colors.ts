export const claret = '#751A33';
export const mediumCarmine = '#B34233';
export const chineseBronze = '#D28F33';
export const vegasGold = '#D4B95E';
export const cadetBlue = '#4EA2A2';
export const metallicSeaweed = '#1A8693';

export const bananaYellow = '#FFDB34';
export const yellowOrange = '#FFAC46';
export const sunsetOrange = '#F95D58';
